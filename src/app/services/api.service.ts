...
export class ApiService {
 ...
 modificaUtente(params) {
  ...
  ritornaBackups() {
    this.controlloPresenzaUtente();
    const url = this.variabiliGlobali.urlWS + 'wsDB.asmx/RitornaBackups'
      ;
      // 'Password=' + this.sistemaTesto(params.Password;
    // console.log('Login:', url);
    const ritorno = this.httpclient.get(url);
  ...
  effettuaRestore(params) {
    this.controlloPresenzaUtente();
    const url = this.variabiliGlobali.urlWS + 'wsDB.asmx/EffettuaRestore?' +
      'QualeBackup=' + params.QualeBackup + '&' +
      'EsegueBackup=SI'
      ;
      // 'Password=' + this.sistemaTesto(params.Password;
    // console.log('Login:', url);
